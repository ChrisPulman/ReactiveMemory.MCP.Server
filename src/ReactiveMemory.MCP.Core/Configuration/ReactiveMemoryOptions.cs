...
/// <summary>Configuration options for the ReactiveMemory core.</summary>
public sealed class ReactiveMemoryOptions
{
    /// <summary>Gets or sets the core storage root.</summary>
    ...
    /// <summary>Gets or sets the logical drawer collection name.</summary>
    public string CollectionName { get; set; } = "reactivememory_drawers";

    /// <summary>Gets or sets the logical relay/closet collection name used for compact routing metadata.</summary>
    public string RelayCollectionName { get; set; } = "reactivememory_relays";

    /// <summary>Gets or sets the write-ahead log directory root.</summary>
    ...
    /// <summary>Gets or sets the hook/checkpoint state directory root.</summary>
    ...
    /// <summary>Gets or sets the default agent/session identifier used for automatic prompt filing.</summary>
    public string DefaultAgentName { get; set; } = "mcp";

    /// <summary>Gets or sets the sector used for automatic prompt filing.</summary>
    public string PromptSector { get; set; } = "sector_sessions";

    /// <summary>Gets or sets the vault used for automatic prompt filing.</summary>
    public string PromptVault { get; set; } = "prompt-history";

    /// <summary>Gets or sets the similarity threshold above which a prompt is treated as already stored.</summary>
    public double PromptDuplicateThreshold { get; set; } = 0.985;

    /// <summary>Gets or sets the number of related memories returned when reacting to a prompt.</summary>
    public int PromptRelatedMemoryLimit { get; set; } = 5;

    /// <summary>Gets or sets a value indicating whether prompt reactions also learn entity registry entries.</summary>
    public bool PromptEntityLearningEnabled { get; set; } = true;

    /// <summary>Gets or sets the number of memories in a managed category that triggers automatic summarisation.</summary>
    public int AutoManageSummaryThreshold { get; set; } = 8;

    /// <summary>Gets or sets the retention window for short-term context before pruning recommends it as stale.</summary>
    public int ShortTermContextRetentionDays { get; set; } = 14;

    /// <summary>
    /// Gets or sets the minimum interval between automatic prune dry-runs triggered by managed-memory writes.
    /// Explicit prune tool calls are never throttled.
    /// </summary>
    public int AutoManagePruneIntervalMinutes { get; set; } = 15;
