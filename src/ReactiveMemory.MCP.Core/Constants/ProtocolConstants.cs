...
/// <summary>Static protocol metadata for ReactiveMemory server negotiation and operational guidance.</summary>
public static class ProtocolConstants
{
    /// <summary>ReactiveMemory operational protocol presented to clients and agents.</summary>
    public const string CoreProtocol =
        ...
        + "3. Retrieve managed memory with reactivememory_context_pack for bounded cross-project recall, or use reactivememory_memory_get_relevant (memory.getRelevant equivalent), reactivememory_search, reactivememory_search_relays, or reactivememory_facts_query before claiming stored knowledge.\n"
        ...
        + "10. Queue repository mining with reactivememory_catalog_project so scans run on the bounded background worker; poll or cancel with the catalog lifecycle tools, and inspect legacy vector upgrades with reactivememory_migrate_legacy_storage before applying them.\n"
    ...
    /// <summary>AAAK definition and storage guidance for ReactiveMemory.</summary>
    ...
    /// <summary>Gets supported protocol versions in newest-first order.</summary>
    public static IReadOnlyList<string> SupportedProtocolVersions { get; } =
    [
        "2026-04-09",
    ];
}
