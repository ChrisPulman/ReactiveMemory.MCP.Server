...
public class KnowledgeGraphTests
{
    ...
    public async Task Knowledge_Graph_Can_Add_Query_Invalidate_And_Readd_Facts()
    {
        ...
        var added = await ReactiveMemoryTools.KnowledgeGraphAddAsync(harness.Service, "Dr. Chen", "works_on", "Project Atlas", "2026-01-01", "closet-1");
        ...
        var readd = await ReactiveMemoryTools.KnowledgeGraphAddAsync(harness.Service, "Dr. Chen", "works_on", "Project Atlas", "2026-03-01", "closet-2");
